		...
		<div class="divTableBody">
			...
			<c:forEach items="${studentList}" var="student" varStatus="status">
				<div class="divTableRow">
					...
					<div class="divTableCell text-left">${student.getClassStudent().getClassName()}</div>
					<div class="divTableCell text-left">${student.getClassStudent().getGrade().getGradeName()}</div>
					<security:authorize access="hasRole('ROLE_ADMIN')">
						<div class="divTableCell">
							<form method="get"
